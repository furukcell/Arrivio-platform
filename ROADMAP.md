...
| Step 10 | Next | Provider query fallback kaldırma ve admin-provider kullanıcı bağlama akışı. |
| Step 11 | Pending | Komisyon takibi. |
| Step 12 | Pending | QR kaynak takibi. |
| Step 13 | Pending | Rent a car formu. |
| Step 14 | Pending | Otel uygunluk talep formu. |
| Step 15 | Pending | Bilet talep formu. |
| Step 16 | Pending | Mobil MVP. |
...
- [x] Provider sadece kendisine atanmış transfer taleplerini görebilecek. Auth profile önceliklidir; query fallback sadece test içindir.
...
| İlk 7 gün | Admin panel | Admin login olup gelen transfer talebini görebilir ve sağlayıcıya atayabilir |
