...
| Step 8 | Next | Firestore Security Rules, admin role guard, provider query fallback kaldırma. |
| Step 9 | Pending | Komisyon takibi. |
| Step 10 | Pending | QR kaynak takibi. |
| Step 11 | Pending | Rent a car formu. |
| Step 12 | Pending | Otel uygunluk talep formu. |
| Step 13 | Pending | Bilet talep formu. |
| Step 14 | Pending | Mobil MVP. |
...
- [ ] Provider başka provider'ın müşterisini göremez. Canlı için Firestore rules gerekir.
