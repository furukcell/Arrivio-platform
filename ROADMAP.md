...
| Step 9 | Next | Admin role guard, provider query fallback kaldırma, ilk admin/provider profil oluşturma akışı. |
| Step 10 | Pending | Komisyon takibi. |
| Step 11 | Pending | QR kaynak takibi. |
| Step 12 | Pending | Rent a car formu. |
| Step 13 | Pending | Otel uygunluk talep formu. |
| Step 14 | Pending | Bilet talep formu. |
| Step 15 | Pending | Mobil MVP. |
