...
export default function ProviderLoginPage() {
  ...
  const [status, setStatus] = useState("Sign in with your provider account.");
  ...
  return createElement(
    "main",
    { style: pageStyle },
    createElement("h1", { style: { fontSize: "42px", margin: "0 0 12px" } }, "Provider Login"),
    createElement("p", { style: { color: "#4B5563", marginBottom: "24px" } }, status),
    createElement("label", null, "Email"),
    createElement("input", { style: inputStyle, value: email, onChange: (event) => setEmail(event.currentTarget.value), placeholder: "provider@example.com" }),
