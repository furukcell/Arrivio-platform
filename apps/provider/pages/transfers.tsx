  ...
  function renderTransferCard(request: TransferRequest) {
    ...
    return createElement("article", { key: requestId, style: cardStyle },
      ...
      request.id ? createElement("section", { style: { marginTop: "12px", paddingTop: "12px", borderTop: "1px solid #E5E7EB" } },
        createElement("h3", { style: { margin: "0 0 8px" } }, "Price / Note"),
        createElement("input", { style: inputStyle, value: priceInputs[request.id] ?? (typeof request.estimatedTotalPrice === "number" ? String(request.estimatedTotalPrice) : ""), onChange: (event) => setPrice(request.id || "", event.currentTarget.value), placeholder: "Price offer" }),
