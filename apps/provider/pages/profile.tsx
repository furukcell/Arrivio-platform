...
export default function ProviderProfilePage() {
  ...
  return createElement("main", { style: pageStyle },
    ...
    createElement("h1", { style: { fontSize: "40px", margin: "18px 0 8px" } }, "Provider Profile"),
    ...
    createElement("section", { style: cardStyle },
      ...
      createElement("p", { style: { color: "#64748B", lineHeight: 1.5 } }, "Next step: connect business profile editing here. Provider name, phone, WhatsApp, active status, verification documents and notes will be managed from this screen."),
      createElement("p", { style: { color: "#64748B", lineHeight: 1.5, fontWeight: 800 } }, `Role: ${appUser?.role || "not set"} / Provider type: ${appUser?.providerType || "not set"}`),
      providerId ? createElement("a", { href: "/prices", style: linkStyle }, "Open Prices") : createElement("a", { href: "/login", style: linkStyle }, "Login"),
